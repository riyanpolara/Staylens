...
/**
 * Safety net for anything the page's own error handling does not catch (a render
 * fault, a thrown detail fetch). Data-layer failures are handled inline so the
 * toolbar survives; this boundary is the last resort.
 */
    ...
    <section className="admin-rise">
      <div className="card elev-sm admin-empty" role="alert">
        ...
        <p className="text-muted">
          The Users screen could not be rendered.{" "}
